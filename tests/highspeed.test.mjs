...
assert.ok(sender.includes("tail % 2 === 0") && sender.includes("highReplayStep"), "high-FPS quad repair stream must alternate systematic replays with fountain repairs to avoid a long decode tail");
