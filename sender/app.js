(() => {
  ...
  function layoutMetrics(patterns) {
    ...
    // Keep the backing store on an integer module grid, but do not let an
    // integer-scale boundary make a denser QR version visibly smaller. The
    // pixelated CSS stretch distributes the remaining device pixels while
    // preserving hard black/white edges.
